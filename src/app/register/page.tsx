        ...
        <div style={{ maxWidth: "448px", display: "flex", flexDirection: "column", gap: "32px" }} className="w-full animate-fadeIn">
          ...
          <div className="text-center">
            ...
            <p className="text-gray-400 text-sm">
              Join URLTRIM and start shortening your links
            </p>
          </div>
            ...
            <div style={{ padding: "32px", display: "flex", flexDirection: "column", gap: "24px" }}>
              <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: "20px" }}>
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: "8px" }}>
                  ...
                  <p style={{ marginTop: "4px" }} className="text-xs text-gray-500 dark:text-gray-400">
                ...
                <button
                  type="submit"
                  disabled={loading}
                  style={{ paddingTop: "14px", paddingBottom: "14px", gap: "8px" }}
